...
import { c, ink } from "@/lib/palette";

/* Static hero, ported 1:1 from the live marketing site. The Day 3 hero-film
   track replaces this component with the scrolled "search that travels" film. */
export default function Hero() {
  return (
    <div
      id="hero"
      style={{
        padding: "clamp(56px,6vw,88px) clamp(24px,3.3vw,48px) 20px",
        boxSizing: "border-box",
        minHeight: "min(calc(100svh - 74px), 820px)",
        display: "flex",
    ...
    >
      ...
      >
        Build like the world's best are beside&nbsp;you.
      </h1>
      <p
        style={{
          margin: "34px 0 0",
      ...
      >
        Real senior engineers, designers, and operators join your AI coding
        session mid-flight. Delegate the heavy pieces, get expert eyes on the
        work that matters. Instant, on demand, and you stay in your flow.
      </p>
      <p
        style={{
          margin: "26px 0 0",
      ...
      >
        <a
          ...
          style={{
            ...
            borderRadius: "999px",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,0.14),0 1px 2px rgba(28,26,22,0.18),0 12px 24px -10px rgba(47,74,56,0.5)",
          }}
        >
